...
public enum Type {
    ESRI_FIELD_TYPE_DATE, ESRI_FIELD_TYPE_DOUBLE, ESRI_FIELD_TYPE_INTEGER, ESRI_FIELD_TYPE_OID, ESRI_FIELD_TYPE_STRING;

    @JsonValue
    public String toValue() {
        switch (this) {
            case ESRI_FIELD_TYPE_DATE: return "esriFieldTypeDate";
    ...
    public static Type forValue(String value) throws IOException {
        if (value.equals("esriFieldTypeDate")) return ESRI_FIELD_TYPE_DATE;
